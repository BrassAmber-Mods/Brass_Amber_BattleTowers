...
public class BTBlockEntityType {
	...
	public static final RegistryObject<BlockEntityType<BTLandSpawnerEntity>> LAND_MOB_SPAWNER = BLOCK_ENTITY_TYPES.register("land_spawner", () -> BlockEntityType.Builder.of(BTLandSpawnerEntity::new, BTBlocks.LAND_SPAWNER.get()).build(null));
	public static final RegistryObject<BlockEntityType<BTOceanSpawnerEntity>> OCEAN_MOB_SPAWNER = BLOCK_ENTITY_TYPES.register("ocean_spawner", () -> BlockEntityType.Builder.of(BTOceanSpawnerEntity::new, BTBlocks.OCEAN_SPAWNER.get()).build(null));
	public static final RegistryObject<BlockEntityType<BTCoreSpawnerEntity>> CORE_MOB_SPAWNER = BLOCK_ENTITY_TYPES.register("core_spawner", () -> BlockEntityType.Builder.of(BTCoreSpawnerEntity::new, BTBlocks.CORE_SPAWNER.get()).build(null));
	public static final RegistryObject<BlockEntityType<BTNetherSpawnerEntity>> NETHER_MOB_SPAWNER = BLOCK_ENTITY_TYPES.register("nether_spawner", () -> BlockEntityType.Builder.of(BTNetherSpawnerEntity::new, BTBlocks.NETHER_SPAWNER.get()).build(null));
	public static final RegistryObject<BlockEntityType<BTEndSpawnerEntity>> END_MOB_SPAWNER = BLOCK_ENTITY_TYPES.register("end_spawner", () -> BlockEntityType.Builder.of(BTEndSpawnerEntity::new, BTBlocks.END_SPAWNER.get()).build(null));
	public static final RegistryObject<BlockEntityType<BTSkySpawnerEntity>> SKY_MOB_SPAWNER = BLOCK_ENTITY_TYPES.register("sky_spawner", () -> BlockEntityType.Builder.of(BTSkySpawnerEntity::new, BTBlocks.SKY_SPAWNER.get()).build(null));
