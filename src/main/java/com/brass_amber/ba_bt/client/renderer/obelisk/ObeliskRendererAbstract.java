...
public class ObeliskRendererAbstract extends EntityRenderer<BTAbstractObelisk> {
    ...
    public ObeliskRendererAbstract(EntityRendererProvider.Context context, String obeliskType, ModelLayerLocation location) {
        super(context);
