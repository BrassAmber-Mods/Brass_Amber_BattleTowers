...
public class BTTags {
    ...
    public static class Biomes {
        ...
        public static Predicate<Holder<Biome>> BOP_LAND = (p_211672_) ->  BuiltinRegistries.BIOME.getOrCreateTag(Biomes.BIOMESOP_LAND).contains(adjustBiome(p_211672_));
        public static Predicate<Holder<Biome>> BOP_LAND_OVERGROWN = (p_211672_) ->  BuiltinRegistries.BIOME.getOrCreateTag(Biomes.BIOMESOP_LAND_JUNGLE).contains(adjustBiome(p_211672_));
        public static Predicate<Holder<Biome>> BOP_LAND_SANDY = (p_211672_) ->  BuiltinRegistries.BIOME.getOrCreateTag(Biomes.BIOMESOP_LAND_DESERT).contains(adjustBiome(p_211672_));
