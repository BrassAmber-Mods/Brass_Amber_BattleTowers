...
public class BTItems {
	...
	public static final Item SILVER_SKELETON_SPAWN_EGG = registerItem("silver_skeleton_spawn_egg", new SpawnEggItem(BTEntityTypes.SILVER_SKELETON, 0xb4bebf, 0x4a4e4f, new Item.Properties().tab(BrassAmberBattleTowers.BATLETOWERSTAB)));
	...
	public static final Item TAB_ICON_ITEM = registerItem("tab_icon", new OperatorOnlyItem(Blocks.AIR, new Item.Properties().durability(0).stacksTo(0)));
	/**
	...
	private static Item registerMonolithKey(String registryName) {
		Item newMonolithKeyItem = new MonolithKeyItem((new Item.Properties()).stacksTo(16).rarity(Rarity.RARE).tab(BrassAmberBattleTowers.BATLETOWERSTAB));
	...
	private static Item registerGuardianEye(String registryName, GolemType golemType) {
		Item newGuardianEyeItem = new GuardianEyeItem(golemType, (new Item.Properties()).stacksTo(8).rarity(Rarity.EPIC).tab(BrassAmberBattleTowers.BATLETOWERSTAB));
	...
	private static Item registerMonolith(String registryName, EntityType<MonolithEntity> monolithEntityType) {
		Item newMonolithItem = new MonolithItem(monolithEntityType, (new Item.Properties()).stacksTo(1).rarity(Rarity.EPIC).tab(BrassAmberBattleTowers.BATLETOWERSTAB));
