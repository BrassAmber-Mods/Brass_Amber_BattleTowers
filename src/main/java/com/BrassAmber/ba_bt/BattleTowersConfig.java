...
public class BattleTowersConfig {
    ...
    static {
        ...
        landAverageSeperationModifier = BUILDER.comment("This value is added to the Land Tower minimum separation"
                        ...
                        "I.E. if you leave the minimum separation at 24, and change this value to 10 then Land Towers would spawn"
                                + " on average 34 chunks apart and a minimum of 24 chunks apart.")
