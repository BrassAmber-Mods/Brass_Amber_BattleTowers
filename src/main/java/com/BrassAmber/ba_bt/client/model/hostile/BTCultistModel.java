...
public class BTCultistModel<T extends Mob & RangedAttackMob> extends HumanoidModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(16, 48).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(1.9F, 12.0F, 0.0F));
