...
public class BTJigsawManager {
    ...
    public static void addPieces(DynamicRegistries p_242838_0_, AbstractVillagePiece p_242838_1_, int p_242838_2_, BTJigsawManager.IPieceFactory p_242838_3_, ChunkGenerator p_242838_4_, TemplateManager p_242838_5_, List<? super AbstractVillagePiece> p_242838_6_, Random p_242838_7_) {
        MutableRegistry<JigsawPattern> mutableregistry = p_242838_0_.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY);
        BTJigsawManager.Assembler jigsawmanager$assembler = new BTJigsawManager.Assembler(mutableregistry, p_242838_2_, p_242838_3_, p_242838_4_, p_242838_5_, p_242838_6_, p_242838_7_);
        jigsawmanager$assembler.placing.addLast(new BTJigsawManager.Entry(p_242838_1_, new MutableObject<>(VoxelShapes.INFINITY), 0, 0));
    ...
    static final class Assembler {
        ...
        private final BTJigsawManager.IPieceFactory factory;
        private final ChunkGenerator chunkGenerator;
        private final TemplateManager structureManager;
        private final List<? super AbstractVillagePiece> pieces;
        private final Random random;
        private final Deque<BTJigsawManager.Entry> placing = Queues.newArrayDeque();

        private Assembler(Registry<JigsawPattern> p_i242005_1_, int p_i242005_2_, BTJigsawManager.IPieceFactory p_i242005_3_, ChunkGenerator p_i242005_4_, TemplateManager p_i242005_5_, List<? super AbstractVillagePiece> p_i242005_6_, Random p_i242005_7_) {
                                    ...
                                    if (JigsawBlock.canAttach(template$blockinfo, template$blockinfo1)) {
                                        ...
                                        if (!VoxelShapes.joinIsNotEmpty(mutableobject1.getValue(), VoxelShapes.create(AxisAlignedBB.of(mutableboundingbox3).deflate(0.25D)), IBooleanFunction.ONLY_SECOND)) {
                                            ...
                                            if (p_236831_4_ - 1 <= this.maxDepth) {
                                                this.placing.addLast(new BTJigsawManager.Entry(abstractvillagepiece, mutableobject1, l, p_236831_4_ + 1));
                                            }
                                            continue label139;
                                        }
                                    }
    ...
    static final class Entry {
        ...
        private Entry(AbstractVillagePiece p_i232042_1_, MutableObject<VoxelShape> p_i232042_2_, int p_i232042_3_, int p_i232042_4_) {
            ...
            BTJigsawManager.LOGGER.warn("Bound Top = {}  Position = {}", this.boundsTop, this.piece.getPosition());
