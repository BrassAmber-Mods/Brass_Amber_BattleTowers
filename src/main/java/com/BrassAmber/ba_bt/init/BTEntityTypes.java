...
public class BTEntityTypes {
	...
	public static final RegistryObject<EntityType<BTObelisk>> NETHER_OBELISK = ENTITY_TYPES.register("nether_obelisk", () -> EntityType.Builder.<BTObelisk>of(BTObelisk::new, MobCategory.MISC).sized(1.0F, 2.0F).setTrackingRange(100).fireImmune().immuneTo(Blocks.TNT).noSummon().build("neter_obelisk"));
