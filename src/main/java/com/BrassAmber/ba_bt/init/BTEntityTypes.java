...
import com.BrassAmber.ba_bt.entity.hostile.PlatinumSkeletonEntity;
...
public class BTEntityTypes {
	...
	public static final EntityType<PlatinumSkeletonEntity> PLATINUM_SKELETON = buildEntityType("silver_skeleton", EntityType.Builder.of(PlatinumSkeletonEntity::new, EntityClassification.MONSTER).sized(0.6F, 1.99F).clientTrackingRange(8));
	...
	public static void onRegisterEntityTypes(Register<EntityType<?>> event) {
		...
		registerSpawnPlacement(PLATINUM_SKELETON, MonsterEntity::checkMonsterSpawnRules);
	}
	...
	public static void initializeAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(PLATINUM_SKELETON, PlatinumSkeletonEntity.createAttributes().build());
	}
