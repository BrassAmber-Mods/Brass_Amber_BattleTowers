...
public class LandBattleTowerTop extends Structure<NoFeatureConfig> {
    public LandBattleTowerTop(Codec<NoFeatureConfig> codec) {
        super(codec);
    }

    @Override
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return LandBattleTowerTop.Start::new;
    }
